...
function MatchDetails(match: Match) {
...
function Template({ children, match }: { children: React.ReactNode; match: Match }) {
  ...
  return (
    <Template match={match}>
      <Section className="bg-white p-8">
        ...
        {/* Match Details */}
        <Section className="mb-6 rounded-lg bg-gray-50 p-6"></Section>
