      ...
      <Section className="bg-white p-8">
        ...
        <Section className="mb-6 rounded-lg bg-gray-50 p-6">
          <div className="flex flex-col items-center justify-center">
            <Text className="m-0 text-sm text-gray-600">Winner</Text>
            <Text className="mb-1 text-lg font-semibold text-gray-800">{match.winner.firstName}</Text>
            <Text className="m-0 text-sm text-gray-600">{match.result}</Text>
          </div>
        </Section>
