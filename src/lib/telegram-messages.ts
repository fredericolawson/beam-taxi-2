...
import { getFirstDriver } from './tables/drivers';

const bot = new TelegramBot();

export async function sendTripRequest({ tripId }: { tripId: string }) {
  console.log('sendTripRequest', tripId);
