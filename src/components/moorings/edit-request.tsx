...
export function EditRequest({ request }: { request: Request }) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-8 md:flex-row">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Tabs value={field.value} onValueChange={field.onChange} className="w-[400px]">
                    <TabsList>
